...
const fgImage = new Image(); fgImage.onload = assetLoaded; fgImage.src = './assets/foreground.png';
...
function render() {
    ...
    if (gameState.assetsLoaded) {
        ...
        // Define specific patches of the foreground.png to draw as overlays
        // Because foreground.png has transparent background, these rects ONLY draw the objects!
        const fgRegions = [
